			...
			<?php while( $items->have_media() ) : $items->the_media(); ?>
				...
				<div class='mpp-g mpp-bulk-edit-media-item' id="mpp-edit-media-<?php mpp_media_id(); ?>">
					...
					<div class="mpp-u-2-24">
						<input type="checkbox" id="mpp-delete-media-check[<?php echo $media_id;?>]" name="mpp-delete-media-check[<?php echo $media_id;?>]" class="mpp-delete-media-check" value='1' /><label for="mpp-delete-media-check[<?php echo $media_id;?>]" class="screen-reader-text"><?php _e( 'Delete media check', 'mediapress' ); ?></label>
					</div>
