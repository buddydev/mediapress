...
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jquery */ "jquery");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _src_globals__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./src/globals */ "./assets/js/src/globals.js");



(function ($) {
  $(document).ready(function () {
    console.log("MPP Core Loaded"); // Lightbox Code

    let isLightBoxLoaded = mpp.lightbox.isLoaded(); // Lightbox popup for activity.
    ...
    if (isLightBoxLoaded && _mppSettings.enable_activity_lightbox) {
      $(document).on('click.mpp:activity:lightbox.mpp:lightbox', '.mpp-activity-media-list a.mpp-activity-media, .mpp-activity-media-list a.mpp-activity-item-title', function () {
        ...
        if ($parent.length) {
          position = $this.parents('.mpp-container').find('.mpp-activity-item-content').index($parent); // newer template
          // or non photo media
        ...
        media_id = $this.data('mpp-media-id'); //open lightbox
    ...
    if (isLightBoxLoaded) {
      $(document).on('click.mpp:shortcode:lightbox.mpp:lightbox', '.mpp-shortcode-lightbox-enabled a.mpp-media-thumbnail, .mpp-shortcode-lightbox-enabled a.mpp-media-title', function () {
        ...
        let media_ids = $container.data('media-ids'),
            url = $this.attr('href'),
            position = 0,
            // $( 'a.mpp-media-thumbnail', $container) .index( $this );
...
/******/ })()
;
//# sourceMappingURL=mpp.dist.js.map