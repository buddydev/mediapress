...
function mppp_group_enable_form() {
    ...
    <div class="checkbox mpp-group-gallery-enable">
		<label for="mpp-enable-gallery"><input type="checkbox" name="mpp-enable-gallery" id="mpp-enable-gallery" value="yes" <?php echo checked( 1, mpp_group_is_gallery_enabled() );?>/> <?php _e( 'Enable Gallery', 'mediapress' ) ?></label>
    </div>
<?php
